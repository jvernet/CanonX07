...
174 IFPJ<=0THENPRINT"   Tu as gagnŽ":BEEP20,10:BEEP10,8:GOSUB600:GOTO500
...
505 GOSUB600
510 IFQ$="O"THEN50
520 CLS:LOCATE3,1:PRINT"Au revoir !":CONSOLEÃ ,1
...
810 FORQ=1TO3:Q1=A(Q):PRINTCHR$(D+Q1);CHR$(D);:NEXT:PRINT
820 BEEP1,16:RETURN
...
912 FONT$(225)="252,252,252,236,252,252,252,0"
914 RETURN
